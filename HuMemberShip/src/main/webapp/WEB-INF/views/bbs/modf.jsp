...
<h3> 글쓰기 화면 </h3>
<form action="mod" method="post" id="frm" encType="multipart/form-data">
	제목 <input type="text" name="title" id='title' value=${bbsvo.title }>
	작성자<input type="text" name="name" id="name" value=${bbsvo.name } readonly>
	내용<input type="text" name="body" value=${bbsvo.body }>
